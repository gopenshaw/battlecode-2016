...
import uber.message.Message;
import uber.message.MessageBuilder;
import uber.message.MessageParser;
import uber.util.DirectionUtil;
import uber.util.LocationUtil;
import uber.util.RobotUtil;
...
public abstract class Robot {
    ...
    protected Direction previousRoundsSafestDirection = Direction.NONE;

    private static int sensorRadius;
    ...
    protected void setLocationsOfEnemies(RobotInfo[] locationsOfEnemies) {
